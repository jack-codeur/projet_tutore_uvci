...
<body>
    ...
    <div id="pcoded" class="pcoded">
        ...
        <div class="pcoded-container navbar-wrapper">
            ...
            @include('layouts.templates.partials.admin.navbar')

            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">

                    @include('layouts.templates.partials.admin.sidebar')
    ...
    <script type="text/javascript" src="{{ asset('assets/popper.js/popper.min.js') }}"></script>
    ...
    <script src="{{ asset('assets/pages/dashboard/amchart/js/light.js') }}"></script>
